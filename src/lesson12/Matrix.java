...
public class Matrix implements IMatrix {
    ...
    public Matrix() {
        numbers = new double[IMatrix.DEFAULT_MATRIX_SIZE][IMatrix.DEFAULT_MATRIX_SIZE]; // Минимальная матрица 1Х1
    }

    public Matrix(int row, int col) { // Колличество строк, колличество колонок
