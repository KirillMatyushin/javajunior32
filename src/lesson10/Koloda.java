...
public class Koloda implements IKoloda {
    ArrayList<Card> cards = new ArrayList<>(); // Коллекция - безразмерный массив (с картами)

    public Koloda() {
        this.preparedCards();
    } // Вызвать метод preparedCards() у обьекта this (колода)
    ...
    public Card getRandomCard() {
        // Дом. задание - сделать так, чтобы колода уменьшалась и удалялись карты, которые мы вытянули
